...
\begin{itemize}
	...
	%No hace falta porque no tiene atributos ni relaciones propias, queda determinada por el campo tipo en eleccion.
	%\item \textbf{Eleccion\_Cargo\_Federal} (\pk{idEleccion}) 
	%\begin{itemize}
	%	\item PK = CK = FK = \{idEleccion\}
	%\end{itemize}
	%\vspace{1mm}
...
%	No hace falta, queda determinado por el campo tipo de voto ya que no tienen relaciones ni atributos particulares. 
%	\item \textbf{Voto\_A\_Plesbiscito\_A\_Favor} (\pk{idVoto}) 
%	\begin{itemize}
%		\item PK = CK = \{idVoto\}
%		\item FK = \{idVoto\}
%	\end{itemize}
%	\vspace{1mm}
%
%	\item \textbf{Voto\_A\_Plesbiscito\_En\_Contra} (\pk{idVoto}) 
%	\begin{itemize}
%		\item PK = CK = \{idVoto\}
%		\item FK = \{idVoto\}
%	\end{itemize}
...
las pks no son autoincrement por motivos de testing.